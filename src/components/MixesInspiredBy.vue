        ...
        <RouterLink :to="to" class="relative ">
            <div class="flex items-center bg-[#23232D] rounded-sm h-[54px] relative">
                <div class="flex items-center w-[54px]" @mouseenter="$event => isHover = true" @mouseleave="$event => isHover = false">
                    ...
                    />
                    <div 
                    :class="isHover ? 'transitione ease-in duration-100 bg-opacity-1000': 'transition ease-out duration-100 bg-opacity-0'"
                ...
                <div class="truncate w-full ml-4">
                    <p class="hover:underline truncate maw-w-[95%] text-gray-200 font-light text-[15px] cursor-pointer">
                        {{ text }}
                    </p>
