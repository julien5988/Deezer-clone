...
const props = defineProps({ category: String, image: String, text: String, to: String })

const { category, image, text, to } = toRefs(props)
</script>
  ...
  <div>
    <RouterLink :to="to" class="relative">
      ...
      >
        ...
        />
        <img class="absolute contrast-[0.55] right-0 top-0 w-1/2" :src="image.one" />
        <img class="absolute contrast-[0.55] left-0 top-0 w-1/2" :src="image.two" />
        <img class="absolute contrast-[0.55] right-0 bottom-0 w-1/2" :src="image.three" />
        <img class="absolute contrast-[0.55] left-0 bottom-0 w-1/2" :src="image.four" />
