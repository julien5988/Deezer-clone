...
<template>
    ...
    <div class="flex items-center w-full relative h-full px-8 mt-6 min-w-[650px]">
      ...
      <div class="ml-8">
        ...
        <div class="flex gap-4 items-center justify-start bottom-0 mb-1.5">
          <button class="p-2.5 px-6 rounded-full bg-[#EF5465]" @click="$event => playFunc()">
  ...
  <div id="SongSection" class="max-w-[1500px] mx-auto">
    <div class="pl-8">
      ...
      <div class="flex items-center border border-[#525254] bg-[#23232D] rounded-sm text-sm text-[#c9c9c9] w-[300px]">
